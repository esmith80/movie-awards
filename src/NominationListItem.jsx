  ...
  return (
    <>
      <div className='nom-item'>
        ...
        <img onClick={() => { remove(imdbID) }} src="https://cdn1.iconfinder.com/data/icons/bold-purple-part1/32/84_Close_Remove_Circle_Cross_Delete-512.png" height="20" width="20" alt="delete" />
      </div>
    </>
  );
};